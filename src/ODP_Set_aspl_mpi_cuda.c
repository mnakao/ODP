#include "common.h"
#include <mpi.h>
extern void ODP_Init_aspl_mpi_general(const int nodes, const int degree, const int* num_degrees, MPI_Comm comm);
extern void ODP_Init_aspl_mpi_grid(const int width, const int height, const int degree, const int* num_degrees, MPI_Comm comm);
