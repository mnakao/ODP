...
double calc_general_min_temp_s()
{
  return -2.0 / log(0.0001);
}

double calc_general_min_temp()
{
  return calc_general_min_temp_s();
}

double calc_grid_min_temp_s()
{
  return calc_general_min_temp_s();
}

double calc_grid_min_temp()
{
  return calc_general_min_temp_s();
}
...
double calc_general_max_temp_s(const int nodes, const int degree, const int seed, const int symmetries)
{
...
double calc_grid_max_temp_s(const int width, const int height, const int degree, const int length,
			    const int seed, const int symmetries)
{
...
double calc_general_max_temp(const int nodes, const int degree, const int seed)
{
  return calc_general_max_temp_s(nodes, degree, seed, 1);
}

double calc_grid_max_temp(const int width, const int height, const int degree, const int length,
			  const int seed)
{
  return calc_grid_max_temp_s(width, height, degree, length, seed, 1);
}
