...
extern double calc_min_temp(int nodes);
...
int main(int argc, char *argv[])
{
  ...
  //    char *cmdline="~/work/metis-5.1.0/bin/gpmetis test.txt 2 | grep Edgecut | awk '{print $3}' | awk -F, '{print $1}'";
//  char *cmdline="LD_LIBRARY_PATH=~/work/mt-metis-0.7.2/lib  ~/work/mt-metis-0.7.2/bin/mtmetis n256d6.graph 2 | grep Edgecut | awk '{print $3}' | awk -F, '{print $1}'";
