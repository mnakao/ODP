...
extern void ODP_Conv_edge2adjacency_grid_2uds(int width, int height, int lines, int degree, int (*edge)[2], int (*adjacency)[degree]);
extern void ODP_Conv_edge2adjacency_grid_2lrs(int width, int height, int lines, int degree, int (*edge)[2], int (*adjacency)[degree]);
extern void ODP_Conv_edge2adjacency_grid_4s(int width, int height, int lines, int degree, int (*edge)[2], int (*adjacency)[degree]);
