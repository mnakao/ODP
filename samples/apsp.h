...
extern void apsp_generate_random_general(int nodes, int degree, unsigned int seed, int (*edge)[2]);
extern void apsp_generate_random_grid(int width, int height, int degree, int length, unsigned int seed, int (*edge)[2]);
#endif
